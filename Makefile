...
egrapher.native :
	ocamlbuild -use-ocamlfind -pkgs llvm,llvm.analysis,llvm.linker,llvm.bitreader,llvm.irreader -cflags -w,+a-4 egrapher.native
...
egrapher : $(OBJS)
	ocamlfind ocamlopt -linkpkg -package llvm.linker -package llvm.bitreader -package llvm.irreader -package llvm -package llvm.analysis $(OBJS) -o egrapher
